...
<div class="h-screen flex bg-gray-50 overflow-hidden">
  ...
  <div class="fixed inset-y-0 left-0 z-50 w-64 bg-white shadow-lg transform {sidebarOpen ? 'translate-x-0' : '-translate-x-full'} transition-transform duration-300 ease-in-out lg:translate-x-0 lg:static lg:inset-0 flex flex-col">
    ...
    <nav class="flex-1 px-4 py-4 space-y-2 overflow-y-auto" aria-label="Navegación principal">
      <a href="/dashboard/entrenador" class={getNavItemClasses('/dashboard/entrenador')} aria-current={isActive('/dashboard/entrenador') ? 'page' : undefined}>
      ...
      <a href="/dashboard/entrenador/clientes" class={getNavItemClasses('/dashboard/entrenador/clientes')} aria-current={isActive('/dashboard/entrenador/clientes') ? 'page' : undefined}>
      ...
      <a href="/dashboard/entrenador/entrenamientos" class={getNavItemClasses('/dashboard/entrenador/entrenamientos')} aria-current={isActive('/dashboard/entrenador/entrenamientos') ? 'page' : undefined}>
      ...
      <a href="/dashboard/entrenador/cuestionarios" class={getNavItemClasses('/dashboard/entrenador/cuestionarios')} aria-current={isActive('/dashboard/entrenador/cuestionarios') ? 'page' : undefined}>
      ...
      <a href="/dashboard/entrenador/estadisticas" class={getNavItemClasses('/dashboard/entrenador/estadisticas')} aria-current={isActive('/dashboard/entrenador/estadisticas') ? 'page' : undefined}>
      ...
      <a href="/dashboard/entrenador/profile" class={getNavItemClasses('/dashboard/entrenador/profile')} aria-current={isActive('/dashboard/entrenador/profile') ? 'page' : undefined}>
